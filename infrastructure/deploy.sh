...
echo ""
echo -e "${BLUE}For the hackathon demo, make sure to:${NC}"
echo "  - Record the GCP console showing the running service"
echo "  - Show the Cloud Run logs during a live call"
echo "  - Demonstrate the architecture diagram"
echo ""
